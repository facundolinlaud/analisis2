...
% facu
\usepackage{float}% Provides: floating section anchoring (i.e. figure[H])
\usepackage{amsmath}
\usepackage{amsthm}
\usepackage{amssymb}
\usepackage{teorema}
...
\newtheorem{propotition}[theorem]{Proposicion}
% /facu
...
\begin{titlepage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
	...
	\parbox[t]{0.93\textwidth}{ % Box to inset this section slightly
		...
		{\Large Facundo Linlaud}\\[4pt] % Extra space after name
		% Department Name\\
...
\tableofcontents
\newpage
\input{sections/sucesiones}
\input{sections/espacios}
\input{sections/conjuntos}
\input{sections/funciones}
\input{sections/derivadas-y-diferencial}
\end{titlepage}
